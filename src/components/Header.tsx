              ...
              {isAdmin && (
                <>
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-bold shadow-2xs transition-all active:scale-95"
                  >
                    <Sparkles className="w-3.5 h-3.5" />
                    <span>AI ช่วยตาราง</span>
                  </button>

                  <button
                    onClick={onResetSchedule}
                    className="p-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-xs font-medium border border-slate-300 transition-all flex items-center justify-center gap-1"
                    title="คืนค่าตารางหลัก"
                  >
                    <RefreshCw className="w-3.5 h-3.5" />
                    <span className="hidden lg:inline text-xs font-bold">คืนค่าตารางหลัก</span>
                  </button>
                </>
              )}
